...
- Lower the repository ingest defaults to `MINIFLUX_SCAN_LIMIT=200` and `INGEST_ACTIONABLE_LIMIT=15` so new environments inherit the balanced production cost baseline.
